...
class LongsorResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'status' => get_variable_status_longsor($total_curah_hujan/$jumlah_curah_hujan,count($this->riwayat_bencana->toArray()), $this->kemiringan_lahan->kemiringan_indeks)
