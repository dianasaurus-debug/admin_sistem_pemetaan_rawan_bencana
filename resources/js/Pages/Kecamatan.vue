                                        ...
                                        <div class="">
                                            <div class="mb-4">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="Masukkan Nama Kecamatan" v-model="form.kec_nama">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input
                                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    id="exampleFormControlInput2" v-model="form.kec_latitude"
...
export default {
    ...
    methods: {
        ...
        searchData: function () {
            this.$inertia.get(`/kecamatan?cari=${this.query}`)
        },
        clearSearch: function () {
            this.query = '';
            this.$inertia.get(`/kecamatan`)
        },
        reset: function () {
            this.form = {
                kec_nama: null,
